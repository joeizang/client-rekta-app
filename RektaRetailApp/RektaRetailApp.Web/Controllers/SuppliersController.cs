...
namespace RektaRetailApp.Web.Controllers
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        public async Task<ActionResult<PaginatedResponse<SupplierViewModel>>> GetSuppliers([FromQuery]GetAllSuppliersQuery? query)
        {
            if (query != null)
            {
        ...
        public async Task<ActionResult<Response<SupplierDetailViewModel>>> GetSupplierById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Response<SupplierViewModel>>> Post(CreateSupplierCommand command)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Response<SupplierDetailViewModel>>> Put(int id, [FromBody] UpdateSupplierCommand command)
        {
            command.Id = id;
            var result = await _mediator.Send(command);
